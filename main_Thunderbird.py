...
import os, shutil
folder = r'/Users/zlifr/Desktop/OCDIGCN/Data/Thunderbird/processed'
...
folder = r'/Users/zlifr/Desktop/OCDIGCN/Data/Thunderbird/Raw'
for filename in os.listdir(folder):
    file_path = os.path.join(folder, filename)
    try:
        if os.path.isfile(file_path) or os.path.islink(file_path):
...
src_dir = r'/Users/zlifr/Desktop/OCDIGCN/Data/Thunderbird/Graph/Raw/'
 
# path to destination directory
dest_dir = r'/Users/zlifr/Desktop/OCDIGCN/Data/Thunderbird/Raw/'
